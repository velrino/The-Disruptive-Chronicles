...
public sealed class ScreenshotUtility : EditorWindow, IHasCustomMenu
{
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        {
            ...
            EditorGUI.BeginDisabledGroup(SavePath == string.Empty);
            {
                ...
                {
                    if (GUILayout.Button("Capture", GUILayout.MinHeight(25)))
                    {
                        RenderScreenshot();
                    }
                }
            ...
            {
                UseCompression = GUILayout.Toggle(UseCompression, "PNG", EditorStyles.miniButtonLeft, GUILayout.Width(50f), GUILayout.ExpandWidth(false));
                UseCompression = !GUILayout.Toggle(!UseCompression, "JPG", EditorStyles.miniButtonRight, GUILayout.Width(50f), GUILayout.ExpandWidth(false));
    ...
    {
        SettingsService.OpenUserPreferences("Editor/Screenshot");
    }
}